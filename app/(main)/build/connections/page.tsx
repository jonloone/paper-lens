...
export default function ConnectionsPage() {
  ...
  const saveNewConnection = async () => {
    ...
    // Navigate to monitor connections to show the new connection
    router.push('/monitor/connections');
  ...
  return (
    <div className="w-full px-8 lg:px-12 xl:px-16 py-6 space-y-4">
        ...
        <div className="flex items-center justify-between pt-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {activeTab !== 'add' && (
              <Button
                size="sm"
                onClick={() => router.push('/build/connections?tab=add')}
              >
      ...
      <Tabs 
        value={activeTab}
        onValueChange={(value) => router.push(`/build/connections?tab=${value}`)}
        className="space-y-4"
      >
